//
// Created by Aleudillonam on 7/31/2022.
//

#ifndef OJOIE_IMGUISTYLES_HPP
#define OJOIE_IMGUISTYLES_HPP
...
static void StyleColorsSpectrum() {
    ...
    colors[ImGuiCol_BorderShadow]          = ColorConvertU32ToFloat4(Spectrum::GRAY700);
    colors[ImGuiCol_CheckMark]             = ImVec4(0.84f, 0.84f, 0.84f, 1.f);
    ...
    colors[ImGuiCol_ButtonActive]          = ImVec4(0.24f, 0.37f, 0.56f, 1.f);
    colors[ImGuiCol_HeaderActive]          = ImVec4(0.17f, 0.36f, 0.53f, 1.f);
    ...
    colors[ImGuiCol_DragDropTarget]        = ImVec4(0.23f, 0.47f, 0.73f, 1.f);
    colors[ImGuiCol_NavHighlight]          = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
    colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
    colors[ImGuiCol_NavWindowingDimBg]     = ImVec4(0.80f, 0.80f, 0.80f, 0.20f);
//    colors[ImGuiCol_ModalWindowDimBg]      = ImVec4(0.2f, 0.2f, 0.2f, 1.f);
    ...
    colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.24f, 0.37f, 0.56f, 1.00f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.17f, 0.36f, 0.53f, 1.00f);
    colors[ImGuiCol_Tab]                    = ImVec4(0.24f, 0.24f, 0.24f, 1.00f);
    colors[ImGuiCol_TabHovered]             = ImVec4(0.21f, 0.44f, 0.65f, 1.00f);
    colors[ImGuiCol_TabActive]              = ImVec4(0.17f, 0.36f, 0.53f, 1.00f);
    ...
    colors[ImGuiCol_Header]                 = ImVec4(0.17f, 0.36f, 0.53f, 1.00f);
    colors[ImGuiCol_HeaderHovered]          = ImVec4(0.24f, 0.50f, 0.74f, 1.00f);
    colors[ImGuiCol_ModalWindowDimBg]       = ImVec4(0.20f, 0.20f, 0.20f, 0.00f);
    ...
    style->PopupRounding = style->TabRounding = style->ChildRounding = style->GrabRounding = style->WindowRounding = 2.3f;
    style->WindowTitleAlign = { 0.5f, 0.5f };
    style->ItemSpacing = { 2.f, 4.f };
    style->FramePadding = { 8.f, 3.f };
    style->ItemInnerSpacing = { 2.f, 4.f };
