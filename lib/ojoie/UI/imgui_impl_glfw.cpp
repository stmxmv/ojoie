...
static void ImGui_ImplGlfw_UpdateMouseCursor(const AN::RenderContext &context) {
    ImGuiIO &io             = ImGui::GetIO();
    ImGui_ImplGlfw_Data *bd = ImGui_ImplGlfw_GetBackendData();
//    if ((io.ConfigFlags & ImGuiConfigFlags_NoMouseCursorChange) || context.cursorState == AN::kCursorStateDisabled) {
//        return;
//    }
    ...
    if (imgui_cursor == ImGuiMouseCursor_None || io.MouseDrawCursor) {
        ...
        AN::Dispatch::async(AN::Dispatch::Main,
                            [window = bd->Window,
                             cursor = bd->MouseCursors[imgui_cursor] ? bd->MouseCursors[imgui_cursor] :
